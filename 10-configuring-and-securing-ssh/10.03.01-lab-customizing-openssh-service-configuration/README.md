...
2.	Выполните команду `su`, чтобы переключиться на пользователя *operator2* на **serverb**. Используйте *redhat* в качестве пароля пользователя *operator2*.
...
5.	Убедитесь, что вы можете войти на **servera** как пользователь *operator2*, используя ключи SSH.
  ...
  5.1.	Установите SSH-подключение к **servera** как пользователь *operator2*.
...
6.	Убедитесь, что вы можете войти на **servera** как пользователь *root* с паролем *redhat*.
  ...
  6.1.	Установите SSH-подключение к **servera** как пользователь *root* с паролем *redhat*.
...
7.	Убедитесь, что вы можете войти на **servera** как пользователь *operator3* с паролем *redhat*.
  ...
  7.1.	Установите SSH-подключение к **servera** как пользователь *operator3* с паролем *redhat*.
